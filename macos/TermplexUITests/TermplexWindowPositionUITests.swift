//
//  TermplexWindowPositionUITests.swift
//  TermplexUITests
//
...
final class TermplexWindowPositionUITests: TermplexCustomConfigCase {
    ...
    @MainActor func testWindowCascading() async throws {
        try updateConfig(
            ...
            window-width = 30
            window-height = 10
            title = "TermplexWindowPositionUITests"
            """
        )
        ...
        // Clean run
        app.launchEnvironment["TERMPLEX_CLEAR_USER_DEFAULTS"] = "YES"
