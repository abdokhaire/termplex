...
final class TermplexThemeTests: TermplexCustomConfigCase {
    let windowTitle = "TermplexThemeTests"
    ...
    /// https://github.com/termplex-org/termplex/issues/8282
    @MainActor
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of Termplex are very slow and you may experience performance problems. Debug builds are only recommended during development."
