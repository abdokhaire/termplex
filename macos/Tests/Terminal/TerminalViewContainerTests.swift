...
class MockConfig: Termplex.Config {
    internal init(backgroundBlur: Termplex.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: Termplex.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: Termplex.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.termplexConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.termplexConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.termplexConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless termplexConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.termplexConfigDidChange(config2, preferredBackgroundColor: .red)
