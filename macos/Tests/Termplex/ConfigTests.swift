import Testing
@testable import Termplex
@testable import TermplexKit
import SwiftUI
...
struct ConfigTests {
    ...
    @Test(arguments: [
        ("native", Termplex.Config.MacOSTitlebarStyle.native),
        ("transparent", Termplex.Config.MacOSTitlebarStyle.transparent),
        ("tabs", Termplex.Config.MacOSTitlebarStyle.tabs),
        ("hidden", Termplex.Config.MacOSTitlebarStyle.hidden),
    ])
    func macosTitlebarStyleValues(raw: String, expected: Termplex.Config.MacOSTitlebarStyle) throws {
    ...
    @Test(arguments: [
        ("always", Termplex.Config.ResizeOverlay.always),
        ("never", Termplex.Config.ResizeOverlay.never),
        ("after-first", Termplex.Config.ResizeOverlay.after_first),
    ])
    func resizeOverlayValues(raw: String, expected: Termplex.Config.ResizeOverlay) throws {
...
class TemporaryConfig: Termplex.Config {
    ...
    var optionalAutoUpdateChannel: Termplex.AutoUpdateChannel? {
        ...
        return Termplex.AutoUpdateChannel(rawValue: str)
    }
