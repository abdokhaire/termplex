...
class NonNativeFullscreen: FullscreenBase, FullscreenStyle {
    ...
    func enter() {
        ...
        // lose it (see: https://github.com/termplex-org/termplex/issues/6999).
        ...
        // https://github.com/termplex-org/termplex/issues/1996
    ...
    private func fullscreenFrame(_ screen: NSScreen) -> NSRect {
        ...
        if !NSApp.presentationOptions.contains(.autoHideMenuBar) &&
            ...
            // if a bug is reported to Termplex we can just advise the user to
            // update.
