// This file contains the configuration types for Termplex so that alternate targets
// can get typed information without depending on all the dependencies of TermplexKit.
