            ...
            if operation == [] && !dragCancelledByEscape {
                ...
                if !endsInWindow {
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [Foundation.Notification.Name.termplexSurfaceDragEndedNoTargetPointKey: screenPoint]
                    )
                }
            }
...
extension Notification.Name {
    ...
    static let termplexSurfaceDragEndedNoTarget = Notification.Name("termplexSurfaceDragEndedNoTarget")

    /// Key for the screen point where the drag ended in the userInfo dictionary.
    static let termplexSurfaceDragEndedNoTargetPointKey = "endedAtPoint"
}
