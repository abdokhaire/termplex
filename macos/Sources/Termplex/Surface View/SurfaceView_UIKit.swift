...
extension Termplex {
    ...
    class SurfaceView: UIView, ObservableObject {
        ...
        var surfaceSize: termplex_surface_size_s? {
            guard let surface = self.surface else { return nil }
            return termplex_surface_size(surface)
        }

        private(set) var surface: termplex_surface_t?
        ...
        func sizeDidChange(_ size: CGSize) {
            ...
            termplex_surface_set_content_scale(surface, scale, scale)
            termplex_surface_set_size(
                surface,
