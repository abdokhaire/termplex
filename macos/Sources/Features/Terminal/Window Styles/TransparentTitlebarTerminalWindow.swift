...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: Termplex.SurfaceView.DerivedConfig?
    ...
    override func syncAppearance(_ surfaceConfig: Termplex.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: Termplex.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: Termplex.SurfaceView.DerivedConfig) {
