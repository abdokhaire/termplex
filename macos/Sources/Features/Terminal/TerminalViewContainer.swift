...
class TerminalViewContainer: NSView {
    ...
    func termplexConfigDidChange(_ config: Termplex.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: Termplex.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
