...
struct AboutView: View {
    ...
    private let githubURL = URL(string: "https://github.com/termplex-org/termplex")
    private let docsURL = URL(string: "https://termplex.org/docs")

    /// Read the commit from the bundle.
    private var build: String? { Bundle.main.infoDictionary?["CFBundleVersion"] as? String }
    private var commit: String? { Bundle.main.infoDictionary?["TermplexCommit"] as? String }
