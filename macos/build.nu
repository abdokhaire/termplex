...
# Build the macOS Termplex app using xcodebuild with a clean environment
# to avoid Nix shell interference (NIX_LDFLAGS, NIX_CFLAGS_COMPILE, etc.).

def main [
    --scheme: string = "Termplex"       # Xcode scheme (Termplex, Termplex-iOS, DockTilePlugin)
    ...
    let project = ($env.FILE_PWD | path join "Termplex.xcodeproj")
