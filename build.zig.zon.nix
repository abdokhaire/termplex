  ...
  linkFarm name [
    {
      ...
      path = fetchZigArtifact {
        name = "bindings";
        url = "https://deps.files.termplex.org/DearBindings_v0.17_ImGui_v1.92.5-docking.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "breakpad";
        url = "https://deps.files.termplex.org/breakpad-b99f444ba5f6b98cac261cbb391d8766b34a5918.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "fontconfig";
        url = "https://deps.files.termplex.org/fontconfig-2.14.2.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "freetype";
        url = "https://deps.files.termplex.org/freetype-1220b81f6ecfb3fd222f76cf9106fecfa6554ab07ec7fdc4124b9bb063ae2adf969d.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "gettext";
        url = "https://deps.files.termplex.org/gettext-0.24.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "glslang";
        url = "https://deps.files.termplex.org/glslang-12201278a1a05c0ce0b6eb6026c65cd3e9247aa041b1c260324bf29cee559dd23ba1.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "gobject";
        url = "https://deps.files.termplex.org/gobject-2025-11-08-23-1.tar.zst";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        ...
        url = "https://deps.files.termplex.org/gtk4-layer-shell-1.1.0.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "harfbuzz";
        url = "https://deps.files.termplex.org/harfbuzz-11.0.0.tar.xz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "highway";
        url = "https://deps.files.termplex.org/highway-66486a10623fa0d72fe91260f96c892e41aceb06.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "iterm2_themes";
        url = "https://deps.files.termplex.org/termplex-themes-release-20260216-151611-fc73ce3.tgz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "jetbrains_mono";
        url = "https://deps.files.termplex.org/JetBrainsMono-2.304.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "libpng";
        url = "https://deps.files.termplex.org/libpng-1220aa013f0c83da3fb64ea6d327f9173fa008d10e28bc9349eac3463457723b1c66.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "libxev";
        url = "https://deps.files.termplex.org/libxev-34fa50878aec6e5fa8f532867001ab3c36fae23e.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "libxml2";
        url = "https://deps.files.termplex.org/libxml2-2.11.5.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        ...
        url = "https://deps.files.termplex.org/NerdFontsSymbolsOnly-3.4.0.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "oniguruma";
        url = "https://deps.files.termplex.org/oniguruma-1220c15e72eadd0d9085a8af134904d9a0f5dfcbed5f606ad60edc60ebeccd9706bb.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "pixels";
        url = "https://deps.files.termplex.org/pixels-12207ff340169c7d40c570b4b6a97db614fe47e0d83b5801a932dcd44917424c8806.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        ...
        url = "https://deps.files.termplex.org/plasma_wayland_protocols-12207e0851c12acdeee0991e893e0132fc87bb763969a585dc16ecca33e88334c566.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "sentry";
        url = "https://deps.files.termplex.org/sentry-1220446be831adcca918167647c06c7b825849fa3fba5f22da394667974537a9c77e.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "spirv_cross";
        url = "https://deps.files.termplex.org/spirv_cross-1220fb3b5586e8be67bc3feb34cbe749cf42a60d628d2953632c2f8141302748c8da.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "utfcpp";
        url = "https://deps.files.termplex.org/utfcpp-1220d4d18426ca72fc2b7e56ce47273149815501d0d2395c2a98c726b31ba931e641.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "uucode";
        url = "https://deps.files.termplex.org/uucode-0.2.0-ZZjBPqZVVABQepOqZHR7vV_NcaN-wats0IB6o-Exj6m9.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "vaxis";
        url = "https://deps.files.termplex.org/vaxis-7dbb9fd3122e4ffad262dd7c151d80d863b68558.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "wayland";
        url = "https://deps.files.termplex.org/wayland-9cb3d7aa9dc995ffafdbdef7ab86a949d0fb0e7d.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        ...
        url = "https://deps.files.termplex.org/wayland-protocols-258d8f88f2c8c25a830c6316f87d23ce1a0f12d9.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "wuffs";
        url = "https://deps.files.termplex.org/wuffs-122037b39d577ec2db3fd7b2130e7b69ef6cc1807d68607a7c232c958315d381b5cd.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "z2d";
        url = "https://deps.files.termplex.org/z2d-0.10.0-j5P_Hu-6FgBsZNgwphIqh17jDnj8_yPtD8yzjO6PpHRQ.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "zf";
        url = "https://deps.files.termplex.org/zf-3c52637b7e937c5ae61fd679717da3e276765b23.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "zig_js";
        url = "https://deps.files.termplex.org/zig_js-04db83c617da1956ac5adc1cb9ba1e434c1cb6fd.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "zig_objc";
        url = "https://deps.files.termplex.org/zig_objc-f356ed02833f0f1b8e84d50bed9e807bf7cdc0ae.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "zig_wayland";
        url = "https://deps.files.termplex.org/zig_wayland-1b5c038ec10da20ed3a15b0b2a6db1c21383e8ea.tar.gz";
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        name = "zlib";
        url = "https://deps.files.termplex.org/zlib-1220fed0c74e1019b3ee29edae2051788b080cd96e90d56836eea857b0b966742efb.tar.gz";
