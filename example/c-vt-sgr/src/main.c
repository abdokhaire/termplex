...
int main() {
  ...
  result = termplex_sgr_set_params(parser, params, separators, sizeof(params) / sizeof(params[0]));
  assert(result == TERMPLEX_SUCCESS);
  ...
  while (termplex_sgr_next(parser, &attr)) {
    ...
    switch (attr.tag) {
      case TERMPLEX_SGR_ATTR_UNDERLINE:
        printf("Underline style = ");
        switch (attr.value.underline) {
          case TERMPLEX_SGR_UNDERLINE_NONE:
            printf("none\n");
            break;
          case TERMPLEX_SGR_UNDERLINE_SINGLE:
            printf("single\n");
            break;
          case TERMPLEX_SGR_UNDERLINE_DOUBLE:
            printf("double\n");
            break;
          case TERMPLEX_SGR_UNDERLINE_CURLY:
            printf("curly\n");
            break;
          case TERMPLEX_SGR_UNDERLINE_DOTTED:
            printf("dotted\n");
            break;
          case TERMPLEX_SGR_UNDERLINE_DASHED:
            printf("dashed\n");
            break;
          default:
      ...
      case TERMPLEX_SGR_ATTR_DIRECT_COLOR_FG:
      ...
      case TERMPLEX_SGR_ATTR_DIRECT_COLOR_BG:
      ...
      case TERMPLEX_SGR_ATTR_UNDERLINE_COLOR:
      ...
      case TERMPLEX_SGR_ATTR_BG_8:
        printf("Background 8-color = %d\n", attr.value.bg_8);
        break;

      case TERMPLEX_SGR_ATTR_FG_256:
        printf("Foreground 256-color = %d\n", attr.value.fg_256);
        break;

      case TERMPLEX_SGR_ATTR_BG_256:
      ...
      case TERMPLEX_SGR_ATTR_ITALIC:
        printf("Italic\n");
        break;

      case TERMPLEX_SGR_ATTR_UNSET:
        printf("Reset all attributes\n");
        break;

      case TERMPLEX_SGR_ATTR_UNKNOWN:
