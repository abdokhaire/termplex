...
This example demonstrates how to use the Termplex VT library from WebAssembly
...
This will create `zig-out/bin/termplex-vt.wasm`.
...
From the **root of the termplex repository**, serve with a local HTTP server:
