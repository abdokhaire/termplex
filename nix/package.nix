...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    deps = callPackage ../build.zig.zon.nix {name = "termplex-cache-${finalAttrs.version}";};
    ...
    postInstall = ''
      terminfo_src=${
        ...
        then ''"$out/Applications/Termplex.app/Contents/Resources/terminfo"''
      ...
      mv "$out/share/termplex/shell-integration" "$shell_integration/shell-integration"
      ln -sf "$shell_integration/shell-integration" "$out/share/termplex/shell-integration"
