 ...
 * @file vt.h
 *
 * libtermplex-vt - Virtual terminal emulator library
 * 
...
/**
 * @mainpage libtermplex-vt - Virtual Terminal Emulator Library
 *
 * libtermplex-vt is a C library which implements a modern terminal emulator,
 * extracted from the [Termplex](https://termplex.org) terminal emulator.
 *
 * libtermplex-vt contains the logic for handling the core parts of a terminal
...
#ifndef TERMPLEX_VT_H
#define TERMPLEX_VT_H
...
#include <termplex/vt/osc.h>
#include <termplex/vt/sgr.h>
#include <termplex/vt/key.h>
#include <termplex/vt/paste.h>
#include <termplex/vt/wasm.h>
