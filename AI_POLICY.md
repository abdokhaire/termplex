...
The Termplex project has strict rules for AI usage:
...
These rules apply only to outside contributions to Termplex. Maintainers
...
Please remember that Termplex is maintained by humans.
...
Termplex is written with plenty of AI assistance, and many maintainers embrace
