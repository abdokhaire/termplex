...
const log = std.log.scoped(.gtk_termplex_command_palette);
...
const Command = extern struct {
    ...
    pub fn newJump(config: *Config, surface: *Surface) *Self {
        ...
        priv.data = .{
            .jump = .{
                // TODO: Replace with surface id whenever Termplex adds one
