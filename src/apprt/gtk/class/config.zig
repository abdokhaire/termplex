...
const log = std.log.scoped(.gtk_termplex_config);

/// Wraps a `Termplex.Config` object in a GObject so it can be reference
...
pub const Config = extern struct {
    ...
    /// Create a new TermplexConfig from a loaded configuration.
    ///
