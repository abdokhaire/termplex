//! App is the primary GUI application for termplex. This builds the window,
...
/// This is true if the app that Termplex is in is focused. This may
...
/// Termplex is initialized but a well behaved apprt should call
...
/// the focus state of the entire app containing Termplex changes.
...
/// Call to notify Termplex that the color scheme for the app has changed.
