...
fn prepareContext(getProcAddress: anytype) !void {
    ...
    {
        log.warn(
            "OpenGL version is too old. Termplex requires OpenGL {d}.{d}",
...
pub fn surfaceInit(surface: *apprt.Surface) !void {
    ...
    switch (apprt.runtime) {
        ...
        apprt.embedded => {
            // TODO(mitchellh): this does nothing today to allow libtermplex
            // to compile for OpenGL targets but libtermplex is strictly
