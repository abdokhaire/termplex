...
test "url regex" {
    ...
    const cases = [_]struct {
        ...
        .{
            .input = "/Users/termplex.user/code/example.py",
            .expect = "/Users/termplex.user/code/example.py",
        },
        .{
            .input = "/Users/termplex.user/code/../example.py",
            .expect = "/Users/termplex.user/code/../example.py",
        ...
        .{
            .input = "/Users/termplex.user/code/../example.py hello world",
            .expect = "/Users/termplex.user/code/../example.py",
        },
        .{
            .input = "../example.py",
        ...
        .{
            .input = "[link](/home/user/termplex.user/example)",
            .expect = "/home/user/termplex.user/example",
        },
        ...
        .{
            .input = "lib/termplex/terminal.zig:42:10",
            .expect = "lib/termplex/terminal.zig:42:10",
        },
        .{
        ...
        .{
            .input = "~/.config/termplex/config",
            .expect = "~/.config/termplex/config",
        },
        .{
            .input = "directory: ~/src/termplex-org/termplex",
            .expect = "~/src/termplex-org/termplex",
        },
        .{
        ...
        .{
            .input = "project dir: $PWD/src/termplex/main.zig",
            .expect = "$PWD/src/termplex/main.zig",
        },
        ...
        .{
            .input = "loaded from .local/share/termplex/state.db now",
            .expect = ".local/share/termplex/state.db",
        },
        .{
            .input = "../some/where",
            .expect = "../some/where",
        ...
        .{
            .input = "./.config/termplex: Needs upstream (main)",
            .expect = "./.config/termplex",
        },
        .{
