...
/// Termplex's terminfo entry.
pub const termplex: Source = .{
    .names = &.{
        ...
        // features.
        // HACK: This is a hack on a hack...we use "xterm-termplex" to prevent
    ...
    // verify that Termplex does indeed support it and if not we can fix it.
    .capabilities = &.{
        ...
        // actually work with Termplex. todo is to validate these!
