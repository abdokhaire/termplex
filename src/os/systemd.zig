...
/// service. It will return false if Termplex was launched any other way.
///
...
/// systemd notifications. Used by Termplex to inform systemd of the state of the
...
/// should never start Termplex with the `NOTIFY_SOCKET` environment variable set
