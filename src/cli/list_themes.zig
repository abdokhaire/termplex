...
const Action = @import("termplex.zig").Action;
...
/// `Termplex.app/Contents/Resources/termplex/themes`. On Linux, this directory
/// is the `share/termplex/themes` (wherever you installed the Termplex "share"
/// directory). If you're running Termplex from the source, this is the
/// `zig-out/share/termplex/themes` directory.
///
/// You can also set the `TERMPLEX_RESOURCES_DIR` environment variable to point
...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null)
        try stderr.print("Could not find the Termplex resources directory. Please ensure " ++
            "that Termplex is installed correctly.\n", .{});
...
fn resolveAutoThemePath(alloc: std.mem.Allocator) ![]u8 {
    ...
    return try std.fs.path.join(alloc, &.{ base_dir, "auto", "theme.termplex" });
}
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "👻 Termplex Theme Preview 👻");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    "To apply this theme, add the following line to your Termplex configuration:",
                    "",
                    ...
                    "Then add the following line to your Termplex configuration and reload:",
                    "",
                    "config-file = ?auto/theme.termplex",
                    "",
                    "For more details on configuration and themes, visit the Termplex documentation:",
                    "",
                    "https://termplex.org/docs/config/reference",
                };
            ...
            }
            {
                ...
                _ = child.print(
                    &.{
                        ...
                        .{ .text = "via ", .style = standard },
                        .{ .text = "  impure (termplex-env)", .style = color4 },
                    },
                    .{
                        .row_offset = 22,
                        .col_offset = 2,
