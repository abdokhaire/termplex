...
For user documentation, see the main README or [termplex.org](https://termplex.org/docs).
...
in `list_keybinds.zig` contains the help text for `termplex +list-keybinds`.
