//! TermplexWebdata generates all the Termplex website data that is
//! merged with the website for things like config references.
const TermplexWebdata = @This();
...
pub fn init(
...

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_config_out,
            "share/termplex/webdata/config.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_actions_out,
            "share/termplex/webdata/actions.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_commands_out,
            "share/termplex/webdata/commands.mdx",
        ).step);
    }
...
pub fn install(self: *const TermplexWebdata) void {
