...
pub fn genConfig(writer: *std.Io.Writer) !void {
    ...
    try writer.writeAll(
        \\---
        \\title: Reference
        \\description: Reference of all Termplex configuration options.
        \\editOnGithubLink: https://github.com/termplex-org/termplex/edit/main/src/config/Config.zig
        \\---
        \\
        \\This is a reference of all Termplex configuration options. These
