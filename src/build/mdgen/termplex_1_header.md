% TERMPLEX(1) Version @@VERSION@@ | Termplex terminal emulator

# NAME

**termplex** - Termplex terminal emulator

# DESCRIPTION

Termplex is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of Termplex is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, Termplex is a fully standards compliant
