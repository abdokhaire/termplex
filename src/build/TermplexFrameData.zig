//! TermplexFrameData generates a compressed file and zig module which contains (and exposes) the
//! Termplex animation frames for use in `termplex +boo`
const TermplexFrameData = @This();
...
pub fn init(b: *std.Build) !TermplexFrameData {
...
pub fn addImport(self: *const TermplexFrameData, step: *std.Build.Step.Compile) void {
