...
/// The set of key codes that Termplex is aware of. These represent
...
/// UTF-8 and are produced by the associated apprt. Termplex core has
/// no mechanism to map input events to strings without the apprt.
///
/// IMPORTANT: Any changes here update include/termplex.h termplex_input_key_e
pub const Key = enum(c_int) {
    ...
    /// Converts a W3C key code to a Termplex key enum value.
    ///
    ...
    /// Converts a Termplex key enum value to a W3C key code.
